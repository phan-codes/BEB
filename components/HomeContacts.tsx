...
const HomeContacts = () => {
	return (
		<div className="px-10 py-14 flex flex-col justify-center items-center gap-y-6 bg-light dark:bg-dark md:flex-row text-center md:justify-around">
			<Link
				href=""
				className="flex flex-col items-center justify-center gap-y-2 hover:bg-slate-100 px-5 py-3 rounded-full  dark:hover:bg-gradient-to-r dark:hover:from-[#161620] dark:hover:via-[#12121c] dark:hover:to-[#0d0c11] ">
