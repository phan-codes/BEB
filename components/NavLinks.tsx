		...
		<div className="w-[80%] flex justify-center items-center">
            ...
            px-5">
				...
				<div className="hidden lg:block">
					<Link
						href="/contact"
						className="border-gray-400 dark:border-gray-700 border-solid border rounded-full py-2 px-4 bg-transparent outline-none hover:bg-gray-100 dark:hover:bg-gray-950">
						CONTACT US
					</Link>
				</div>
